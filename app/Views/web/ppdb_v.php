...
<body>
    ...
    <div class="banner">
        <div class="content-banner d-flex align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-md p-5 d-flex align-items-center">
                        <div>
                            <h1 class="text text-center text-md-start">PORTAL</h1>
                            <h1 class="text text-center text-md-start">PPDB SMPIT AVICENNA</h1>
                            ...
                            <div class="d-block d-block mx-auto mx-md-0" style="width: fit-content;">
                                <a href="<?= base_url('admin'); ?>" class="btn btn-primary btn-lg rounded-pill px-5 mt-5">LOGIN</a>
                                <a class="d-block text-center mt-3" href="<?= base_url(''); ?>">Back To Website</a>
                            </div>

                        </div>
                    </div>
                    <div class="col-md">
                        <img src="/assets/other/siswa.png" class="w-100" alt="">
                    </div>
                </div>
            </div>
        </div>
