 ...
 <div class="px-3">
     <div class="shadow p-4 mb-4" style="border-radius: 10px;">
         ...
         <div class="data text-center">
             ...
             <p class="d-md-inline d-block warna2 mx-2 mb-0"><i class="bi bi-person-circle"></i> <?= $detail['penulis']; ?></p>
             <p class="d-md-inline d-block warna2 mx-2 mb-0"><i class="bi bi-calendar3"></i> <?= $tanggal; ?></p>
             <p class="d-md-inline d-block warna2 mx-2 mb-0"><i class="bi bi-clock"></i> <?= $jam; ?></p>
             <p class="d-md-inline d-block warna2 mx-2 mb-0"><i class="bi bi-tag"></i> <?= $detail['kategori']; ?></p>
