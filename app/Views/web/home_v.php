...
<div class="content">
    ...
    <section class="about px-md-0 px-3">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-dark d-block my-auto isi-about">
                    <h5>Welcome To</h5>
    ...
    <div class="blog">
        <div class="container">
            ...
            <!-- banner -->
            <div class="banner-2">
                <img src="assets/other/tumbnail.png" alt="" class="w-100">
            </div>
            <!-- end Banner -->

            <div class="blog-card">
                <h1 class="judul-utama">Lates News</h1>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex justify-content-center mb-4">
                            <a href="news/<?= $data['slug']; ?>" class="myhover">
                                <div class="card mycard shadow" style="width: 20rem; height:25rem">
                                    <img src="assets/other/<?= $data['cover']; ?>" class="card-img-top" alt="...">
                                    <div class="card-body">
                ...
                <div class="col-lg-6">
                    ...
                    <?php foreach ($pengumuman as $data) :  ?>
                        <div class="row mb-2">
                            ...
                            <div class="col-10">
                                <div class="isi-pengumuman shadow">
                                    <p class="">
                                        <?= $data['judul']; ?>
                                    </p>
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col d-flex justify-content-center">
                            <a href="#" class="mybtn rounded-pill">view more</a>
                        </div>
                    </div>
    ...
    <div class="program" id="program">
        ...
        <div class="container pb-5 px-md-0 px-4">
